...
namespace gentzen_system
{
	struct proposition : std::enable_shared_from_this< proposition >
	{
		...
		proposition( propositional_symbol s, std::pair< const std::shared_ptr< proposition >, const std::shared_ptr< proposition > > && p ) :
		...
		{ return std::shared_ptr< proposition >( new proposition( propositional_symbol::logical_or, std::make_pair( lhs, rhs ) ) ); }
		static std::shared_ptr< proposition > make_and( const std::shared_ptr< proposition > & lhs, const std::shared_ptr< proposition > & rhs )
		{ return std::shared_ptr< proposition >( new proposition( propositional_symbol::logical_and, std::make_pair( lhs, rhs ) ) ); }
		static std::shared_ptr< proposition > make_not( const std::shared_ptr< proposition > & hs )
		{ return std::shared_ptr< proposition >( new proposition( propositional_symbol::logical_not, std::make_pair( hs, nullptr ) ) ); }
		...
		bool operator < ( const proposition & comp ) const
		{
			...
			else
			{
				...
				{
					if ( comb.s == propositional_symbol::logical_not ) { return * comb.p.first < * comp_comb.p.first; }
					else
					{
