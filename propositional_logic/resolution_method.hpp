#ifndef THEOREM_PROVER_PROPOSITIONAL_LOGIC_RESOLUTION_METHOD
#define THEOREM_PROVER_PROPOSITIONAL_LOGIC_RESOLUTION_METHOD
	...
	namespace propositional_logic
	{
		std::shared_ptr< proposition > move_negation_in( const std::shared_ptr< proposition > & prop )
		{
			...
			else
			{
				...
				else if ( comb.s == logical_and ) { return proposition::make_and( move_negation_in( comb.p.first ), move_negation_in( comb.p.second ) ); }
				else
				{
		...
		std::shared_ptr< proposition > move_or_in( const std::shared_ptr< proposition > & prop )
		{
			...
			else
			{
				...
				if ( comb.s == logical_or )
				{
					...
					if ( fcomb.s == logical_or || fcomb.s == logical_not ) { return proposition::make_or( f, s ); }
					else
					{
				...
				else if ( comb.s == logical_and ) { return proposition::make_and( move_or_in( comb.p.first ), move_or_in( comb.p.second ) ); }
				else
				{
...
#endif //THEOREM_PROVER_PROPOSITIONAL_LOGIC_RESOLUTION_METHOD
